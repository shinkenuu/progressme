...
namespace Assets.Scripts.Model
{
    public class OPPORTUNITY_HISTORY : JSONable
    {
        ...
        public void SetOppHistory(long id, long task_id, int process_id, int responsable_employee_id, DateTime history_date)
        {
            this.id = id;
        ...
        public override JSONObject ToJson()
        {
            ...
            jsonObj.AddField("task_id", task_id);
